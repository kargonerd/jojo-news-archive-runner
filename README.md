...
- Axios's current parser is `axios-parser/0.1.21`, after fixes for partner
  ...
  in the 2019 audit; fresh zero-overlap `holdout-v14` runs for 2016--2026 are
  now dispatched on 0.1.21, and their per-year 800-sample audits must finish
...
- NYT 2019 `holdout-v2` has formally converged at 800/800 on
  ...
  The current parser is now `nyt-parser/0.8.70`: it filters legacy
  ...
  Fresh zero-overlap `holdout-v17` runs for 2016--2026 are dispatched on
  0.8.70, and all earlier NYT evidence remains historical until these audits
  pass.
