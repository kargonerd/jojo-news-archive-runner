...
PUBLISHER_SPECS = {
    ...
    "nyt": PublisherSpec(
        publisher="nyt",
        parser_version="nyt-parser/0.8.68",
    ...
    "ft": PublisherSpec(
        publisher="ft",
        parser_version="ft-parser/0.8.43",
    ...
    "axios": PublisherSpec(
        publisher="axios",
        parser_version="axios-parser/0.1.19",
    ...
    "npr": PublisherSpec(
        publisher="npr",
        parser_version="npr-parser/0.1.37",
    ...
    "zaobao": PublisherSpec(
        publisher="zaobao",
        parser_version="zaobao-parser/0.1.7",
    ...
    "scmp": PublisherSpec(
        publisher="scmp",
        parser_version="scmp-parser/0.1.4",
