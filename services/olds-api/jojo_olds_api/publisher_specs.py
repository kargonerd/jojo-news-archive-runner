...
PUBLISHER_SPECS = {
    ...
    "wsj": PublisherSpec(
        publisher="wsj",
        parser_version="wsj-parser/0.8.57",
    ...
    "nyt": PublisherSpec(
        publisher="nyt",
        parser_version="nyt-parser/0.8.78",
    ...
    "reuters": PublisherSpec(
        publisher="reuters",
        parser_version="reuters-parser/0.7.29",
    ...
    "ft": PublisherSpec(
        publisher="ft",
        parser_version="ft-parser/0.8.50",
    ...
    "axios": PublisherSpec(
        publisher="axios",
        parser_version="axios-parser/0.1.26",
    ...
    "npr": PublisherSpec(
        publisher="npr",
        parser_version="npr-parser/0.1.49",
    ...
    "nikkei": PublisherSpec(
        publisher="nikkei",
        parser_version="nikkei-parser/0.1.7",
    ...
    "zaobao": PublisherSpec(
        publisher="zaobao",
        parser_version="zaobao-parser/0.1.8",
    ...
    "aljazeera": PublisherSpec(
        publisher="aljazeera",
        parser_version="aljazeera-parser/0.1.11",
    ...
    "caixin": PublisherSpec(
        publisher="caixin",
        parser_version="caixin-parser/0.1.10",
