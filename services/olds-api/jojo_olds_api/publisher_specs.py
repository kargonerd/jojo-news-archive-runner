...
PUBLISHER_SPECS = {
    "ap": PublisherSpec(
        publisher="ap",
        parser_version="ap-parser/0.6.10",
        domains=("apnews.com",),
        default_language="en",
        edition="us",
        body_selectors=(
    ...
    "wsj": PublisherSpec(
        publisher="wsj",
        parser_version="wsj-parser/0.8.5",
    ...
    "bloomberg": PublisherSpec(
        publisher="bloomberg",
        parser_version="bloomberg-parser/0.10.3",
    ...
    "nyt": PublisherSpec(
        publisher="nyt",
        parser_version="nyt-parser/0.8.22",
    ...
    "reuters": PublisherSpec(
        publisher="reuters",
        parser_version="reuters-parser/0.7.4",
    ...
    "ft": PublisherSpec(
        publisher="ft",
        parser_version="ft-parser/0.8.7",
