...
PUBLISHER_SPECS = {
    "ap": PublisherSpec(
        publisher="ap",
        parser_version="ap-parser/0.6.22",
        domains=(
            "apnews.com",
            "hosted.ap.org",
            "hosted2.ap.org",
    ...
    "wsj": PublisherSpec(
        publisher="wsj",
        parser_version="wsj-parser/0.8.53",
    ...
    "nyt": PublisherSpec(
        publisher="nyt",
        parser_version="nyt-parser/0.8.64",
    ...
    "ft": PublisherSpec(
        publisher="ft",
        parser_version="ft-parser/0.8.42",
    ...
    "npr": PublisherSpec(
        publisher="npr",
        parser_version="npr-parser/0.1.27",
    ...
    "nikkei": PublisherSpec(
        publisher="nikkei",
        parser_version="nikkei-parser/0.1.6",
    ...
    "zaobao": PublisherSpec(
        publisher="zaobao",
        parser_version="zaobao-parser/0.1.3",
