...
PUBLISHER_SPECS = {
    ...
    "wsj": PublisherSpec(
        publisher="wsj",
        parser_version="wsj-parser/0.8.11",
    ...
    "bloomberg": PublisherSpec(
        publisher="bloomberg",
        parser_version="bloomberg-parser/0.10.8",
    ...
    "nyt": PublisherSpec(
        publisher="nyt",
        parser_version="nyt-parser/0.8.28",
    ...
    "reuters": PublisherSpec(
        publisher="reuters",
        parser_version="reuters-parser/0.7.9",
    ...
    "ft": PublisherSpec(
        publisher="ft",
        parser_version="ft-parser/0.8.12",
