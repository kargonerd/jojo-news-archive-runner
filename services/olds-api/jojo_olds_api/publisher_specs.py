...
PUBLISHER_SPECS = {
    "ap": PublisherSpec(
        publisher="ap",
        parser_version="ap-parser/0.6.13",
        domains=("apnews.com",),
        default_language="en",
        edition="us",
        body_selectors=(
    ...
    "wsj": PublisherSpec(
        publisher="wsj",
        parser_version="wsj-parser/0.8.18",
    ...
    "bloomberg": PublisherSpec(
        publisher="bloomberg",
        parser_version="bloomberg-parser/0.10.21",
    ...
    "nyt": PublisherSpec(
        publisher="nyt",
        parser_version="nyt-parser/0.8.38",
    ...
    "reuters": PublisherSpec(
        publisher="reuters",
        parser_version="reuters-parser/0.7.16",
    ...
    "ft": PublisherSpec(
        publisher="ft",
        parser_version="ft-parser/0.8.20",
