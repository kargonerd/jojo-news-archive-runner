...
PUBLISHER_SPECS = {
    "ap": PublisherSpec(
        publisher="ap",
        parser_version="ap-parser/0.6.16",
        domains=("apnews.com",),
        default_language="en",
        edition="us",
        body_selectors=(
    ...
    "wsj": PublisherSpec(
        publisher="wsj",
        parser_version="wsj-parser/0.8.23",
    ...
    "nyt": PublisherSpec(
        publisher="nyt",
        parser_version="nyt-parser/0.8.45",
    ...
    "reuters": PublisherSpec(
        publisher="reuters",
        parser_version="reuters-parser/0.7.20",
    ...
    "ft": PublisherSpec(
        publisher="ft",
        parser_version="ft-parser/0.8.27",
