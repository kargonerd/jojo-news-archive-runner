...
PUBLISHER_SPECS = {
    ...
    "nyt": PublisherSpec(
        publisher="nyt",
        parser_version="nyt-parser/0.8.49",
    ...
    "axios": PublisherSpec(
        publisher="axios",
        parser_version="axios-parser/0.1.0",
        domains=("axios.com", "www.axios.com"),
        default_language="en",
        edition="us",
        body_selectors=("[data-testid='article-content']", ".ArticleBody", "article"),
        preferred_image_hosts=("images.axios.com",),
        use_structured_article_body=True,
    ),
    "npr": PublisherSpec(
        publisher="npr",
        parser_version="npr-parser/0.1.0",
    ...
    "nikkei": PublisherSpec(
        publisher="nikkei",
        parser_version="nikkei-parser/0.1.0",
        domains=("nikkei.com", "www.nikkei.com"),
        default_language="ja",
        edition="jp",
        body_selectors=(".article-body", ".cmn-article_body", "article"),
        preferred_image_hosts=("www.nikkei.com",),
        use_structured_article_body=True,
    ),
    ...
    "aljazeera": PublisherSpec(
        publisher="aljazeera",
        parser_version="aljazeera-parser/0.1.0",
    ...
    "scmp": PublisherSpec(
        publisher="scmp",
        parser_version="scmp-parser/0.1.0",
        domains=("scmp.com", "www.scmp.com"),
        default_language="en",
        edition="hk",
        body_selectors=(".article__body", ".article-body", "[data-qa='article-body']", "article"),
