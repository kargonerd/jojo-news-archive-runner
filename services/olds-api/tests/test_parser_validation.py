...
def test_nontext_interactive_is_not_a_false_article_body_failure(
    ...
    connection.execute(
        ...
        INSERT INTO parser_validation_config(
            ...
            VALUES (2020, 1, 'test', 'nyt-parser/0.8.75', 2, 'now')
        """
    )
    connection.execute(
        """
...
def test_short_aljazeera_liveblog_shell_is_excluded_from_article_cohort(
    ...
    connection.execute(
        ...
        INSERT INTO parser_validation_config(
            sample_year, target_size, seed, parser_version, qa_revision,
            updated_at
        ) VALUES (2022, 1, 'test', 'aljazeera-parser/0.1.8', 2, 'now')
        """
    )
    connection.execute(
        """
    ...
    connection.execute(
        ...
        INSERT INTO parser_validation_results(
            ...
            parsed_at
        ) VALUES (?, 'aljazeera', 2022, 'aljazeera-parser/0.1.8', 2,
...
def test_npr_short_audio_shell_is_excluded_from_article_cohort(
    ...
    connection.execute(
        ...
        INSERT INTO parser_validation_config(
            sample_year, target_size, seed, parser_version, qa_revision,
            updated_at
        ) VALUES (2014, 1, 'test', 'npr-parser/0.1.49', 1, 'now')
        """
    )
    connection.execute(
        """
...
def test_nyt_print_utility_entry_is_screened_from_article_cohort(
    ...
    connection.execute(
        ...
        INSERT INTO parser_validation_config(
            sample_year, target_size, seed, parser_version, qa_revision,
            updated_at
            ) VALUES (?, 1, 'test', 'nyt-parser/0.8.75', 2, 'now')
        """,
        (sample_year,),
    )
    connection.execute(
