...
def test_parser_combines_split_2012_nyt_article_body_containers():
    ...
    assert result.extraction.parser_version == "nyt-parser/0.8.43"
...
def test_bloomberg_parser_extracts_livemint_partner_story_content():
    ...
    assert result.extraction.parser_version == "bloomberg-parser/0.10.25"
    ...
    result = parse_article(
        ...
        <html><head>
          ...
          <figure>
            ...
            <figcaption><span>Mark Wickens for The New York Times</span>
            </figcaption>
          </figure>
